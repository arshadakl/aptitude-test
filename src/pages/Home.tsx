...
function Home() {
    ...
    return (
        <main className=" bg-iiiwhite  md:py-20">
            <div className=" mx-auto flex flex-col lg:gap-0 gap-5">
                <section className="mx-auto ">
                    <div className="flex justify-center gap-6   items-center flex-col  h-96">
                        <h1 className="text-5xl font-source font-semibold -tracking-[.68px] text-iiiblack text-center w-full">
                ...
                <section>
                    <div className="container mx-auto flex justify-center">
                        <Card className="max-h-96 lg:w-3/6 bg-red-500">
                            <img className="object-none h-full w-full  rounded-xl" src="/images/bg-hero.jpg" alt="" />
                        </Card>
                    </div>
                </section>
                <section>
                    <div className="flex flex-col items-center gap-3 justify-center lg:h-80 h-full ">
                        <h1 className="font-source font-semibold text-iiiblack lg:w-2/4 w-3/4 text-center text-4xl">
                            Our Specialised R&D Team has created <br /> an AI to Find out which course is best for students based on bunch of Questions
                        </h1>
                        <p className="font-inter text-center lg:w-2/5 w-4/5 text-lg leading-6 text-iiiblack">Take the guesswork out of choosing the right career path <br />
                         and make an informed decision that aligns with your <br /> aspirations.</p>
                    </div>
                </section>
                <section>
                    <div className="flex flex-col justify-center items-center font-inter gap-5">
                        <div className="flex flex-col items-center ">
                            <h1 className="text-3xl font-semibold text-iiiblack">How our Specialised Exam can help you?</h1>
                            <Wavunderline />
                        </div>
                        <div className=" bg-[#F9F9F9] rounded-2xl lg:w-5/12 w-11/12 p-14 ">
                                ...
                                {guidanceData.map((item, index) => (
                                    <div key={index}>
                                        <div className="flex flex-col w-full sm:flex-row sm:space-x-6">
                                            <div className="sm:w-60 w-1/3">
                                                <h3 className="text-xl w-10  font-semibold text-gray-900">
                                                    {item.title}
                                                </h3>
                                            </div>

                                            <div className="sm:w-96 w-1/3">
...
function AssessmentButton() {
    ...
    return (
        <>
            <h1 className="text-xl font-inter font-semibold text-center">
